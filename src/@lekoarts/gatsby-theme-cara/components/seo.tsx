...
const SEO = ({ title, description, pathname, image, children }: Props) => {
  ...
  return (
    <Helmet title={title} defaultTitle={defaultTitle} titleTemplate={`%s | ${siteTitle}`}>
      ...
      <link rel="icon" type="image/png" sizes="32x32" href="/iso.png" />
      <link rel="icon" type="image/png" sizes="16x16" href="/iso.png" />
      <link rel="apple-touch-icon" sizes="180x180" href="/iso-solo.png" />
      {children}
    </Helmet>
  )
}
