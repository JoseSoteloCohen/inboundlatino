...
title: Moo Elements
slug: moo-elements
excerpt: Plugin que integra Elementor Pro con Moosend
image: './images/moo-elements-banner.png'
---

![WordPress Plugin Downloads](https://img.shields.io/wordpress/plugin/dt/moo-elements?color=blue)  ![WordPress Plugin Active Installs](https://img.shields.io/wordpress/plugin/installs/moo-elements?color=blue) ![WordPress Plugin Version](https://img.shields.io/wordpress/plugin/v/moo-elements?color=blue) ![WordPress Plugin Rating](https://img.shields.io/wordpress/plugin/stars/moo-elements?color=blue)
